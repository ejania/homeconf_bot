...
USAGE_OPEN = "Используй так: /open <часы> <места> [таймаут_ожидания_ч]"
INVITE_ONLY_PRE_OPEN = "Позвать гостя можно только до открытия общей регистрации."
EVENT_CREATED = "Событие создано! Статус: PRE_OPEN. Спикеры могут звать гостей. Чтобы открыть для всех, напиши /open <часы> <места> [таймаут_ожидания_ч]."
